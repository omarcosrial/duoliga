...
function iconPiggy(cls=''){ return `<span class="duo-svg ${cls}" aria-hidden="true"><svg viewBox="0 0 64 64" width="1em" height="1em"><ellipse cx="35" cy="34" rx="22" ry="18" fill="#ff8da1"/><circle cx="50" cy="28" r="6" fill="#ff8da1"/><circle cx="55" cy="29" r="2.2" fill="#d65c71"/><polygon points="25,18 18,11 17,22" fill="#ff8da1"/><rect x="22" y="47" width="6" height="10" rx="2" fill="#b95f24"/><rect x="40" y="47" width="6" height="10" rx="2" fill="#b95f24"/><circle cx="24" cy="34" r="2.4" fill="#1d3766"/><circle cx="45" cy="33" r="1.8" fill="#ffafbb"/><ellipse cx="12" cy="36" rx="5" ry="7" fill="#ff8da1"/><ellipse cx="15" cy="34" rx="7" ry="6" fill="#ffb6c4"/><circle cx="13" cy="34" r="1.4" fill="#d65c71"/><circle cx="17" cy="34" r="1.4" fill="#d65c71"/><path d="M27 26h15" stroke="#ffffff" stroke-width="3.2" stroke-linecap="round"/><circle cx="42" cy="16" r="7.5" fill="#ffd54a" stroke="#f0ad00" stroke-width="2"/><text x="42" y="19" text-anchor="middle" font-size="8" font-family="Arial" fill="#fff">R$</text></svg></span>`; }
function iconCoins(cls=''){ return `<span class="duo-svg ${cls}" aria-hidden="true"><svg viewBox="0 0 64 64" width="1em" height="1em"><ellipse cx="24" cy="42" rx="14" ry="6" fill="#f2b400"/><path d="M10 26v16c0 3.4 6.3 6 14 6s14-2.6 14-6V26" fill="#ffc928"/><ellipse cx="24" cy="26" rx="14" ry="6" fill="#ffd95a" stroke="#f2b400" stroke-width="2"/><ellipse cx="44" cy="34" rx="12" ry="5.2" fill="#f2b400"/><path d="M32 20v14c0 3 5.4 5.2 12 5.2s12-2.2 12-5.2V20" fill="#ffc928"/><ellipse cx="44" cy="20" rx="12" ry="5.2" fill="#ffd95a" stroke="#f2b400" stroke-width="2"/></svg></span>`; }
...
function homeView(){
  ...
  return `<section class="view ${currentView==='home'?'active':''}">
    ...
    <button class="prize-card" data-view="more"><div class="prize-illus">${iconPiggy('lg')}${iconCoins('md')}</div><div><span>Prêmio acumulado:</span><strong>${money(pot)}</strong></div><div class="prize-coins">${iconCoins('sm')}${iconCoins('sm')}</div><b>›</b></button>
...
function challengesView(){
  ...
  if(challengeMode==='mission'){
    return `<section class="view ${currentView==='challenges'?'active':''}">${challengeSwitcher()}
      ...
      <div class="mission-reward"><div>${iconCoins('sm')} <strong>+2 pts</strong><span>ao concluir</span></div><div class="divider"></div><div>📅 <span>Prazo:</span><strong>domingo</strong></div></div>
...
function moreView(){
  ...
  return `<section class="view ${currentView==='more'?'active':''}">
    ...
    <div class="prize-card static"><div class="prize-illus">${iconPiggy('lg')}${iconCoins('md')}</div><div><span>Prêmio acumulado:</span><strong>${money(pot)}</strong></div><b>›</b></div>
